...
3. Call the [render\(\)](https://github.com/webix-hub/gitbook-webix-jet/tree/2d186f59684fcf9977905010591510a0f43a5297/part-i-basic-usage/api/jetapp-api/jetapp-methods.md#app-render) method of the JetApp instance to paint the UI on the page.
